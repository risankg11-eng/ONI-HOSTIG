...
def create_default_files(server_dir):
    ...
    if not os.path.exists(main_py):
        with open(main_py, 'w', encoding='utf-8') as f:
            f.write('''# AONIK HOSTING - Default Bot
import time

print("=" * 40)
print("Bot is running on AONIK HOSTING")
...
def api_create_server():
    ...
    if not username:
        username = f"AoNIK_CODEX{random.randint(10000, 99999)}"
